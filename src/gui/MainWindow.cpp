...
MainWindow::MainWindow(bool demoMode, QWidget* parent)
  ...
  setWindowTitle(m_demoMode
    ? QStringLiteral("FlyingBytesPro V3.2.28 [DEMO MODE]")
    : QStringLiteral("FlyingBytesPro V3.2.28"));
...
QWidget* MainWindow::createAboutPage(QWidget* parent) {
  ...
  auto* title = new QLabel(QStringLiteral("FlyingBytesPro V3.2.28"), titleBlock);
