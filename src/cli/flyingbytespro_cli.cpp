...
void printHelp(QTextStream& out) {
  out << "FlyingBytesProCLI V3.2.29 - direct libusb USBasp AVR programmer\n\n"
      << "Usage:\n"
...
int main(int argc, char* argv[]) {
  ...
  QCoreApplication::setApplicationVersion(QStringLiteral("V3.2.29"));
