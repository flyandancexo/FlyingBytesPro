...
void printHelp(QTextStream& out) {
  out << "FlyingBytesProCLI V3.2.28 - direct libusb USBasp AVR programmer\n\n"
      << "Usage:\n"
...
int main(int argc, char* argv[]) {
  ...
  QCoreApplication::setApplicationVersion(QStringLiteral("V3.2.28"));
  ...
  } else if (automaticPart && matches.size() > 1) {
